function QuestionIcon() {
  return (
    <svg className="icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M12 13.25V13C12 12.183 12.505 11.74 13.011 11.4C13.505 11.067 14 10.633 14 9.83301C14 9.30257 13.7893 8.79387 13.4142 8.41879C13.0391 8.04372 12.5304 7.83301 12 7.83301C11.4696 7.83301 10.9609 8.04372 10.5858 8.41879C10.2107 8.79387 10 9.30257 10 9.83301"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
