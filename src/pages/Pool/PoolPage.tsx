...
function PoolPage() {
    ...
    return (
        <>
            <DexForm header={t('Your Liquidity')}
                     headerTooltip={t('When you add liquidity, you are given pool tokens that represent your share. If you don’t see a pool you joined in this list, try importing a pool below.')}
                                         ...
                                         return {
                                             ...
                                             content: (
                                                 <div key={index} className="pool-item-details-wrapper">
                                                     ...
                                                     <div>
                                                         <Link className="btn btn-primary add__btn"
