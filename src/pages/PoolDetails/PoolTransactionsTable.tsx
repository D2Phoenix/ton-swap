      ...
      <div className="pool-transactions-wrapper">
        <div className="pool-transactions-header">
          <div className="buttons__column">
            <div className={`link__btn ${filter === '' ? 'active' : ''}`} onClick={handleFilter.bind(null, '')}>
              {t('All')}
            </div>
            <div className={`link__btn ${filter === 'Swap' ? 'active' : ''}`} onClick={handleFilter.bind(null, 'Swap')}>
              {t('Swaps')}
            </div>
            <div className={`link__btn ${filter === 'Mint' ? 'active' : ''}`} onClick={handleFilter.bind(null, 'Mint')}>
              {t('Adds')}
            </div>
            <div className={`link__btn ${filter === 'Burn' ? 'active' : ''}`} onClick={handleFilter.bind(null, 'Burn')}>
              {t('Removes')}
            </div>
          </div>
